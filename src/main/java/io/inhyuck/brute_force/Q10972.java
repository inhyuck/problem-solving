 ...
 * Title: 다음 순열
 * description: 1부터 N까지의 수로 이루어진 순열이 있다. 이때, 사전순으로 다음에 오는 순열을 구하는 프로그램을 작성하시오.
 * Solution Key: Brute Force
 * Problem URL: https://www.acmicpc.net/problem/10972
 */
...
public class Q10972 {
    ...
    public static void main(String[] args) throws IOException {
        ...
        boolean hasNextPermutation = nextPermutation(numbers);
